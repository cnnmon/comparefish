...
export function Avatar({
  ...
  return (
    <div
      className={`absolute z-[1] flex flex-col items-center -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none${dim ? " animate-wiggle-hard" : wiggle ? " animate-wiggle" : ""}`}
      style={{
        left: `${left}%`,
        top: `${top}%`,
